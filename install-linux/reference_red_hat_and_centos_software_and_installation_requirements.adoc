...
* Red Hat Enterprise Linux versões 7.x e de 8,0 a 8,7, com base na arquitetura x86_64.
...
* MySQL Community Edition versão 8.0.32 (do repositório MySQL).
* OpenJDK versão 11.0.18 (do repositório Red Hat extra Enterprise Linux Server)
* Python 3,6.x
